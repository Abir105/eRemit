...
export class AccountNatureService {
  ...
  public getData = (route: string): Observable<any> => {
    return this.http.get('http://10.11.201.87:3001/account_nature');
  };
  ...
  public account_nature_create = ({ route, body }: { route: string, body: any }) => {
    ...
    console.log(body);
    return this.http.post('http://10.11.201.87:3001/account_nature', body);
  };
  public delete = (curid) => {
    const options = {
    ...
    return this.http.delete(`http://10.11.201.87:3001/account_nature/${curid}`, options);
  };

  public updateaccountnature = (route: string, element) => {
    console.log(element);
    return this.http.put('http://10.11.201.87:3001/account_nature', element);
  };
